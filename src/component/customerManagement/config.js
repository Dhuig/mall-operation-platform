...
// 会员最高等级 memberLevelMax
export const MEMBER_LEVEL_MAX = {
	'0': '新用户',
	'1': '星优惠客户',
	'2': '二星优惠客户',
	'3': '三星优惠客户',
...
export const NORMAL_CUSTOMER_SEARCH = {
	form: [
		...
		},
		{
			...
			type: 'select',
			value: '',
			options: optionGenerator(USER_SOURCE),
			placeholder: '请选择顾客来源',
		},
	],
	rules: {
...
export const NORMAL_CUSTOMER_COLUMNS = [
	{ label: '顾客编号', prop: 'memberNo', align: 'center', width: 150 },
	...
	{ label: '顾客来源', prop: 'userSource', align: 'center',
		formatter:({userSource}) => { return USER_SOURCE[userSource] }
	},
	...
	{ label: '分享人/分配人卡号', prop: 'sharerCardNo', align: 'center', width: 130 },
	{ label: '分享人/分配人姓名', prop: 'sharerName', align: 'center', width: 130 },
...
export const ACCOUNT_MANGE = [
	{
		...
		key: 'memberNo',
		buttons: [
			{ name: '账户修改日志', cb: 'viewAccountModifyChangelog', disabled: () => false }
		]
	},
	...
	{ label: '邮箱', key: 'email', type: 'customer' },
	{
		...
		buttons: [
			{
				name: '初始化密码', cb: 'initialPassword', disabled: (val, data) => {
					return data.memberType === 1
				}
			},
			{
				name: '初始化子帐号密码', cb: 'openInitialSubAccountModal', disabled: (val, data) => {
					return data.memberType === 1
				}, type: 'customer'
			},
		],
	...
	{ label: '微信', key: 'wechatNickname', },
	{ label: 'QQ', key: 'qqNickname',  },
	{
		label: '默认配送服务中心',
	...
	{ label: '最近一次变更状态时间', key: 'memberStatusUpdateTime' },
	{ label: '操作人', key: 'updaterName' },
];
// 开单类型
...
export const ORDER_COLUMNS = [
 ...
 },
	{
		...
		formatter: ({ totalAmount }) => {
			return '¥' + filters.toThousandslsFilter(totalAmount);
		}
	},
...
export const AFTERSELL_COLUMNS = [
	...
	{ label: '来源', prop: 'applySourceDesc', align: 'center' },
	{
		label: '退货类型',
		prop: 'returnType',
		align: 'center',
...
// 账户修改日志 搜索配置
export const ACCOUNT_MODIFY_SEARCH = {
	form: [
		{
			label: '顾客编号',
			key: 'memberNo',
...
// 账户修改日志 表格列定义
export const ACCOUNT_MODIFY_COLUMN = [
	{
		label: '操作时间',
		prop: 'createTime',
		align: 'center',
	...
	{ label: '操作类型', prop: 'typeName', align: 'center' },
	{ label: '修改内容', prop: 'content', align: 'center' },
	{ label: '操作人', prop: 'creatorName', align: 'center' },
];
	...
	form: [
		{
			...
			type: 'select',
			value: '',
			options: optionGenerator(MEMBER_FROM, String),
			placeholder: '请选择潜在顾客来源',
		},
		{
			label: '获客时间',
			key: 'allotTimeRange',
		...
		},
		{
			...
			type: 'select',
			value: '',
			options: optionGenerator(CHANGE_TYPE, String),
			placeholder: '请选择分配转化情况',
		},
	],
};

// 潜在顾客列表 列定义
export const POTENTIAL_LIST_COLUMN = [
	{ label: '顾客编号', prop: 'memberNo', align: 'center', width: 120 },
	{label: '会员卡号', prop: 'cardNo', align: 'center', width: 120,},
	{ label: '顾客姓名', prop: 'realname', align: 'center' },
	{ label: '手机号', prop: 'mobile', align: 'center', width: 120 },
	{ label: '微信昵称', prop: 'wechatNickname', align: 'center', width: 120 },
	{ label: '微信union ID', prop: 'unionId', align: 'center', width: 160 },
	{ label: '设备ID', prop: 'equipmentId', align: 'center' },
	{
		label: '顾客来源',
		prop: 'memberFrom',
		align: 'center',
		formatter: ({ memberFrom }) => {
			return memberFrom in MEMBER_FROM ? MEMBER_FROM[memberFrom] : '';
		}
	},
	{ label: '常驻地区', prop: 'usualLocation', align: 'center' },
	{
		...
		formatter: ({ changeType }) => {
			return changeType in CHANGE_TYPE ? CHANGE_TYPE[changeType] : '';
		}
	},
	{
		label: '获客时间',
...
// 顾客资料修改日志 搜索  
export const CUSTOMER_DATA_MODIFY_SEARCH = {
	form: [
		{
			label: '顾客卡号',
			key: 'cardNo',
		...
		},
		{
			...
			type: 'select',
			value: '',
			options: optionGenerator(PLATFORM_TYPE, 'string'),
			placeholder: '请选择平台',
		},
		{
			label: '变更时间',
		...
		},
		{
			...
			type: 'select',
			value: '',
			options: optionGenerator(MODIFY_TYPE, 'string'),
			placeholder: '请选择修改内容',
		},
	],
	rules: {
		...
		// ],
		cardNo: [
			{ min:8,max: 10, message: '请输入 8 ~ 10 位字符', trigger: 'change' }
		],
		mobile: [
			{ required: false, validator: CHECK_MOBLIE_RULE, trigger: 'blur' },
			{ max: 11, message: '请输入11位数有效手机号', trigger: 'change' }
...
// 顾客资料修改日志 表格列定义
export const CUSTOMER_DATA_MODIFY_COLUMNS = [
	{
		label: '操作人工号/卡号',
		align: 'center',
		prop: 'operatorNo',
	...
	},
	{
		...
		align: 'center',
		prop: 'type',
		formatter:({type}) => MODIFY_TYPE[type]
	},
];
