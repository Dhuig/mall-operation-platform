<template>
	<div>
		...
		<el-row type="flex" justify="end" class="marginB20">
			<el-button
				v-permission="'file_classification_add_classification'"
				type="primary"
				icon="el-icon-plus"
		...
		<el-card>
			<el-row type="flex" justify="end">
				<el-button
					v-permission="'file_classification_sort_source'"
				...
				<el-table-column label="操作" :width="450">
					<template slot-scope="scope">
						<el-button
							...
							v-permission="'file_classification_edit'"
							@click="openLabelDialog('编辑文档分类', true, scope.row)"
						>
							编辑
						</el-button>
						<el-button
							...
							v-permission="'file_classification_delete'"
...
export default {
	...
	methods: {
		...
		// 打开新建分类
		openLabelDialog(title = '新建文档分类', show = true, row = null) {
			if (row) {
