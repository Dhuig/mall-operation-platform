...
export default {
	...
	methods: {
		// 下载模板
		downloadTemplate() {
			exportExcel(`/mgmt/inventory/mortgageAmount/exportMortgageAmountMaxStoreReturnTemplate`);
			this.active = 1;
		},
		// 上传文件
		uploadFile() {
		...
		// 导出失败记录
		exportFailLog() {
			exportExcel(`/mgmt/inventory/mortgageAmount/exportMortgageAmountMaxStoreReturnImportFailRecord`);
		},
	},
};
</script>
