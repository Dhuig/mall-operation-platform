<template>
	<div class="contractImport">
		...
		<el-dialog title="上传提示" :visible.sync="uploadVisible" width="500px">
			<el-upload ref="uploadDom" action="/mgmt/store/importContractList" :http-request="uploadCustom"
...
export default {
	...
	methods: {
		// 下载模板
		downloadTemplate() {
			exportExcel(`/mgmt/store/downloadContractExcelTemplate`);
			this.active = 1;
		},
		// 上传文件
		uploadFile() {
		...
		// 导出失败记录
		exportFailLog() {
			exportExcel(`/mgmt/store/exportContractFailList`);
		},
	},
};
</script>
<style lang="scss" scoped>
::v-deep.contractImport {
